...
echo.
echo ========================================
echo JJoMe MIDI Player R2.7d  (English UI)
...
copy "%BUILD_DIR%\MidiPlayer.exe" "%RELEASE_DIR%\JMPlayer_R2.7d_ENG.exe"
...
cd /d "%RELEASE_DIR%"
windeployqt JMPlayer_R2.7d_ENG.exe --release --no-translations --no-opengl-sw
...
echo Executable: %RELEASE_DIR%\JMPlayer_R2.7d_ENG.exe
echo.

if exist "%RELEASE_DIR%\JMPlayer_R2.7d_ENG.exe" (
    for %%A in ("%RELEASE_DIR%\JMPlayer_R2.7d_ENG.exe") do (
