...
echo.
echo ========================================
echo JJoMe MIDI Player V3.0.0 beta  (English UI)
...
copy "%BUILD_DIR%\MidiPlayer.exe" "%RELEASE_DIR%\JMPlayer_V3.0.0-beta_ENG.exe"
...
cd /d "%RELEASE_DIR%"
windeployqt JMPlayer_V3.0.0-beta_ENG.exe --release --no-translations --no-opengl-sw
...
echo Executable: %RELEASE_DIR%\JMPlayer_V3.0.0-beta_ENG.exe
echo.

if exist "%RELEASE_DIR%\JMPlayer_V3.0.0-beta_ENG.exe" (
    for %%A in ("%RELEASE_DIR%\JMPlayer_V3.0.0-beta_ENG.exe") do (
