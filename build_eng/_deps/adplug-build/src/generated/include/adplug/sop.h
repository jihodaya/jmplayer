...
public:
	...
	char GetVoiceNote(int chan) const { return (chan >= 0 && chan < 20) ? voiceNote[chan] : 60; }
...
public:
	...
	unsigned int getnumvoices() { return nTracks; };
...
protected:
	...
	uint8_t real_attack[SOP_MAX_TRACK];
